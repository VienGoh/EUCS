  ...
  return (
    <div className="p-6 bg-gray-50 min-h-screen">
        ...
        <div className="bg-white p-6 rounded-xl shadow-sm border">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              ...
              <p className="text-2xl font-bold text-gray-800">{totalTask}</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="bg-white p-6 rounded-xl shadow-sm border mb-8">
        <h2 className="text-lg font-semibold text-gray-800 mb-4">Performance per Task</h2>
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div className="flex items-center">
                      <div className="w-full bg-gray-200 rounded-full h-2">
                        <div
                          className={`h-2 rounded-full ${task.successRate >= 80 ? 'bg-green-500' : task.successRate >= 60 ? 'bg-yellow-500' : 'bg-red-500'}`}
